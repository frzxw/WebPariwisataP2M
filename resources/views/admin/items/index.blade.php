...
@section('content')
    <div class="px-4 py-8 sm:ml-56">
        <div class="md:mx-8 mb-6">
            <h1 class="font-poppins font-semibold text-2xl text-gray-900 mb-2">Item</h1>
            <p class="text-sm text-gray-600">Kelola dan pantau semua item wisata yang tersedia</p>
        </div>
            ...
            <div class="mx-auto max-w-screen-2xl font-montserrat">
                <div class="relative overflow-hidden bg-white sm:rounded-lg">
                    ...
                    <div
                        ...
                        <button data-modal-target="create-form-modal" data-modal-toggle="create-form-modal" type="button"
                            ...
                            <span class="hidden xs:inline">Tambah Item</span>
                                    ...
                                    <form class="p-4 md:p-5">
                                        <div class="grid gap-4 mb-4 grid-cols-2">
                                            <div class="col-span-2">
                                                <label for="name"
                                                    class="block mb-2 text-sm font-medium text-gray-900">Nama Item</label>
                                            ...
                                            <div class="col-span-2">
                                                <label for="image"
                                                    class="block mb-2 text-sm font-medium text-gray-900">Gambar
                                                    Item</label>
                                                <input type="file" name="image" id="image" accept="image/*"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                                                <p class="mt-1 text-xs text-gray-500">Upload gambar item (JPG, PNG, atau
                                                    GIF, maksimal 2MB)</p>
                                            </div>
                                            ...
                                            <div class="col-span-2">
                                                ...
                                                <textarea id="description" name="description" rows="4"
                                                    ...
                                                    placeholder="Tulis deskripsi item disini..."></textarea>
                                            </div>
                                        </div>
                                        <button type="submit"
                                ...
                                <div class="relative bg-white rounded-lg shadow-sm font-poppins">
                                    ...
                                    <div class="p-4 md:p-5">
                                        <div class="grid gap-4 mb-4">
                                            <!-- Image Display -->
                                            <div class="col-span-2">
                                                <label class="block mb-2 text-sm font-medium text-gray-900">Gambar
                                                    Item</label>
                                                <div class="flex justify-center bg-gray-50 rounded-lg p-4">
                                                    <img src="https://placehold.co/400x300/22c55e/ffffff?text=Flying+Fox"
                                                        alt="Tiket Wahana Flying Fox"
                                                        class="w-full max-w-xs h-48 object-cover rounded-lg border border-gray-200">
                                                </div>
                                            </div>
                                            <div class="grid grid-cols-1 gap-4">
                                                <div>
                                                    ...
                                                    <p class="text-sm text-gray-700 bg-gray-50 p-2.5 rounded-lg">
                                                        Tiket Wahana Flying Fox</p>
                                                </div>
                                                <div>
                                                    <label
                                                        class="block mb-2 text-sm font-medium text-gray-900">Status</label>
                                                    <span
                                                        class="uppercase bg-green-100 text-green-800 text-xs font-bold px-2.5 py-0.5 rounded-sm">Tersedia</span>
                                                </div>
                                            </div>
                                            <div class="grid grid-cols-1 gap-4">
                                                <div>
                                                ...
                                                <div>
                                                    <label
                                                        class="block mb-2 text-sm font-medium text-gray-900">Harga</label>
                                                    <p class="text-sm text-gray-700 bg-gray-50 p-2.5 rounded-lg">Rp 25.000
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="grid grid-cols-1 gap-4">
                                                <div>
                                                    <label class="block mb-2 text-sm font-medium text-gray-900">Stok
                                                        Tersedia</label>
                                                    <p class="text-sm text-gray-700 bg-gray-50 p-2.5 rounded-lg">85 unit
                                                    </p>
                                                </div>
                                                <div>
                                                    <label class="block mb-2 text-sm font-medium text-gray-900">Total
                                                        Terjual</label>
                                                    <p class="text-sm text-gray-700 bg-gray-50 p-2.5 rounded-lg">157 unit
                                                    </p>
                                                </div>
                                            </div>
                                            <div>
                                                <label
                                                    class="block mb-2 text-sm font-medium text-gray-900">Deskripsi</label>
                                                <p class="text-sm text-gray-700 bg-gray-50 p-2.5 rounded-lg min-h-[80px]">
                                                    Nikmati sensasi meluncur di atas pohon dengan flying fox sepanjang 200
                                                    meter. Wahana ini sangat aman dengan standar keselamatan internasional.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <form class="p-4 md:p-5">
                                        <div class="grid gap-4 mb-4 grid-cols-2">
                                            ...
                                            <div class="col-span-2">
                                                ...
                                                <div class="mb-3 flex justify-center bg-gray-50 rounded-lg p-3">
                                                    <img src="https://placehold.co/300x200/22c55e/ffffff?text=Flying+Fox"
                                                        alt="Current Image"
                                                        class="w-32 h-24 object-cover rounded-lg border border-gray-200">
                                                </div>
                                                <input type="file" name="image" id="edit_image" accept="image/*"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                                                <p class="mt-1 text-xs text-gray-500">Upload gambar baru jika ingin
                                                    mengganti (JPG, PNG, atau GIF, maksimal 2MB)</p>
                                            </div>
                                            <div class="col-span-2 sm:col-span-1">
                                                ...
                                                <select id="edit_category" name="category"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
                                                    <option value="wahana" selected>Wahana</option>
                                                    <option value="fasilitas">Fasilitas</option>
                                                    <option value="kuliner">Kuliner</option>
                                                    <option value="souvenir">Souvenir</option>
                                                </select>
                                            ...
                                            <div class="col-span-2 sm:col-span-1">
                                                <label for="edit_price"
                                                    class="block mb-2 text-sm font-medium text-gray-900">Harga</label>
                                                <input type="number" name="price" id="edit_price" value="25000"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                                                    placeholder="Rp 25000" required="">
                                            </div>
                                            <div class="col-span-2 sm:col-span-1">
                                                <label for="edit_stock"
                                                    class="block mb-2 text-sm font-medium text-gray-900">Stok</label>
                                                <input type="number" name="stock" id="edit_stock" value="85"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                                                    placeholder="100" required="">
                                            </div>
                                            <div class="col-span-2 sm:col-span-1">
                                            ...
                                            <div class="col-span-2">
                                                ...
                                                <textarea id="edit_description" name="description" rows="4"
                                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-lime-500 focus:border-lime-500"
                                                    placeholder="Tulis deskripsi item disini...">Nikmati sensasi meluncur di atas pohon dengan flying fox sepanjang 200 meter. Wahana ini sangat aman dengan standar keselamatan internasional.</textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="p-4 md:p-5 text-center">
                                        ...
                                        <div class="mb-4 p-3 bg-gray-50 rounded-lg">
                                            <p class="text-sm text-gray-700">
                                                <span class="font-medium">Nama:</span> Tiket Wahana Flying Fox<br>
                                                <span class="font-medium">Kategori:</span> Wahana<br>
                                                <span class="font-medium">Harga:</span> Rp 25.000
                                            </p>
                                        </div>
                        ...
                        <tbody class="text-xs">
                            <tr class="border-b hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <th scope="row"
                                    ...
                                    <img src="https://placehold.co/400x300/22c55e/ffffff?text=Flying+Fox"
                                        class="w-auto h-8 mr-3 rounded-md">
                                    Tiket Wahana Flying Fox
                                </th>
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">
                                    <span
                                        class="uppercase bg-purple-100 text-purple-800 text-xs font-bold px-2.5 py-0.5 rounded-sm">Wahana</span>
                                </td>
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">
                                    Rp 25.000</td>
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">
                                ...
                                <td class="px-4 py-2 whitespace-nowrap">
                                    <span
                                        class="uppercase bg-green-100 text-green-800 text-xs font-bold me-2 px-2.5 py-0.5 rounded-sm">Tersedia</span>
                                </td>
                                <td class="px-4 py-3 flex items-center justify-center">
                                    <button id="item-1-dropdown-button" data-dropdown-toggle="item-1-dropdown"
                            ...
                            <tr class="border-b hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <th scope="row"
                                    class="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap me-1">
                                    <img src="https://placehold.co/400x300/f97316/ffffff?text=Gudeg"
                                        class="w-auto h-8 mr-3 rounded-md">
                                    Nasi Gudeg Special
                                </th>
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">
                                    <span
                                        class="uppercase bg-orange-100 text-orange-800 text-xs font-bold px-2.5 py-0.5 rounded-sm">Kuliner</span>
                                </td>
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">
                                    Rp 15.000</td>
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">
                                ...
                                <td class="px-4 py-3 flex items-center justify-center">
                                    <button id="item-2-dropdown-button" data-dropdown-toggle="item-2-dropdown"
                                        class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none hover:bg-gray-100 transition-colors duration-150"
                                        type="button">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20"
                                            xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div id="item-2-dropdown"
                                        class="hidden z-10 w-44 bg-white rounded-lg shadow-lg border border-gray-100 divide-y divide-gray-100">
                                        <ul class="py-1 text-sm text-gray-700" aria-labelledby="item-2-dropdown-button">
                                            <li>
                                                <a href="#" data-modal-target="show-modal"
                                                    data-modal-toggle="show-modal"
                                                    class="flex items-center py-2 px-4 hover:bg-gray-100 text-gray-700">
                            ...
                            <tr class="border-b hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <th scope="row"
                                    class="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap me-1">
                                    <img src="https://placehold.co/400x300/3b82f6/ffffff?text=Batik"
                                        class="w-auto h-8 mr-3 rounded-md">
                                    Kaos Batik Borobudur
                                </th>
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">
                                    <span
                                        class="uppercase bg-blue-100 text-blue-800 text-xs font-bold px-2.5 py-0.5 rounded-sm">Souvenir</span>
                                </td>
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">
                                    Rp 45.000</td>
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap">
                                ...
                                <td class="px-4 py-2 whitespace-nowrap">
                                    <span
                                        class="uppercase bg-red-100 text-red-800 text-xs font-bold me-2 px-2.5 py-0.5 rounded-sm">Tidak
                                        Tersedia</span>
                                </td>
                                <td class="px-4 py-3 flex items-center justify-center">
                                    <button id="item-3-dropdown-button" data-dropdown-toggle="item-3-dropdown"
                                        class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none hover:bg-gray-100 transition-colors duration-150"
                                        type="button">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20"
                                            xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div id="item-3-dropdown"
                                        class="hidden z-10 w-44 bg-white rounded-lg shadow-lg border border-gray-100 divide-y divide-gray-100">
                                        <ul class="py-1 text-sm text-gray-700" aria-labelledby="item-3-dropdown-button">
                                            <li>
                                                <a href="#" data-modal-target="show-modal"
                                                    data-modal-toggle="show-modal"
                                                    class="flex items-center py-2 px-4 hover:bg-gray-100 text-gray-700">
